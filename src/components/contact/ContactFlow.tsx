...
type Mode = "keuze" | "contact" | "offerte" | "intake";
...
export function ContactFlow({ initialMode, initialPackageId }: { initialMode?: string; initialPackageId?: string }) {
  ...
  const mode: Mode =
    initialMode === "contact" || initialMode === "offerte" || initialMode === "intake" ? initialMode : "keuze";
  ...
  if (mode === "intake") return <ProjectIntake onBack={goBack} />;
